            ...
            with sqlite3.connect(str(self.db_path)) as conn:
                ...
                cursor.execute(
                    '''INSERT INTO messages 
                       (sender_id, receiver_id, title, content, type, related_id, related_type) 
                       VALUES (?, ?, ?, ?, ?, ?, ?)''',
                    (sender_id, receiver_id, title, content, msg_type, related_id, related_type)
                )
                conn.commit()
