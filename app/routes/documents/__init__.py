...
from .preview import preview_document, preview_document_local, view_document, preview_status, preview_page, start_progressive_preview, preview_converted_pdf, start_batch_pdf_conversion, delete_pdf_conversion
...
document_bp.route('/<path:doc_id>', methods=['GET'])(get_document)
document_bp.route('/preview/<path:doc_id>', methods=['GET'])(preview_document)
document_bp.route('/preview-local/<path:doc_id>', methods=['GET'])(preview_document_local)
document_bp.route('/preview/start/<path:doc_id>', methods=['GET'])(start_progressive_preview)
document_bp.route('/preview/pdf/<cache_key>', methods=['GET'])(preview_converted_pdf)
...
document_bp.route('/view/<path:doc_id>', methods=['GET'])(view_document)
document_bp.route('/download/<path:doc_id>', methods=['GET'])(download_document)
document_bp.route('/progress', methods=['GET'])(get_cycle_progress)
document_bp.route('/<path:doc_id>', methods=['DELETE'])(delete_document)
...
document_bp.route('/<path:doc_id>', methods=['PUT'])(update_doc)
document_bp.route('/<path:doc_id>/replace', methods=['POST'])(replace_doc)
